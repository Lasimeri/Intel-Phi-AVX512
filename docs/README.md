...
| [2026-09-23-mixture-of-experts.md](results/2026-09-23-mixture-of-experts.md) | ggml's MUL_MAT_ID on the cards, which is what an MoE model's expert weights go through, and a backend that judges by measurement whether a card pays for its 0.45 ms of latency on each weight tensor: Qwen3.8-35B-A3B Q4_K_M tg16 8.55 against the host's 7.41, pp512 83.99 against 78.18 |
